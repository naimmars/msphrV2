			        ...
			        <div class="portlet box red">
									...
									<div class="portlet-body form">
										...
										<form action="#" class="form-horizontal">
											<div class="form-body">
												<h4 class="form-section">Address In Malaysia</h4>
												<div class="row">
													<div class="col-md-6">
												...
												<div class="row">
														...
														<div class="form-group">
															...
															<div class="col-md-9">
															    <select name="country" id="select2_sample4" class="select2 form-control">
                                                                    ...
                                                                    <option value="NEG">Negeri Sembilan</option>
                                                                    ...
                                                                    <option value="LAB">W.P Labuan</option>
													...
													<!--/span-->
												<h4 class="form-section">Address In Country of Origin</h4>
												<!--/row-->
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
												...
												<!--/row-->
												<h4 class="form-section">Telephone and Email</h4>
												<!--/row-->
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Telephone (Home)</label>
															<div class="col-md-9">
																<input type="text" class="form-control" >
															</div>
														</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Email (Work)</label>
															<div class="col-md-9">
																<input type="text" class="form-control" >
															</div>
														</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Email (Other)</label>
															<div class="col-md-9">
																<input type="text" class="form-control">
															</div>
														</div>
