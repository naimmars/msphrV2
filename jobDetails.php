			    ...
			    <div class="col-md-12">
			        <div class="portlet box red">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Job Details
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										...
										<form action="#" class="form-horizontal">
											<div class="form-body">
												<h4 class="form-section">Job Info</h4>
												<div class="row">
													<div class="col-md-6">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<select name="relationship" id="select2_sample4" class="select2 form-control" onChange="getData(this);">
                                                                    ...
                                                                    <option value="SPO" onClick="">Contract</option>                                                                                                   <option value="CHI">Permanent</option>
                                                                </select>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Contract Start Date</label>
															<div class="col-md-9">
												                <input type="text" class="form-control" >
															</div>
														</div>
