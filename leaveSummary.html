                    ...
                    <div class="col-md-12">
                        <div class="portlet box red">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-pie-chart"></i>Leave Summary
                                </div>
                                <div class="tools">
                                ...
                                <!-- BEGIN FORM-->
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                                                <div class="dashboard-stat blue-madison">
                                                    ...
                                                    <div class="title">ANNUAL LEAVE</div>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <br>
                                                <h4 class="form-section">List of Leave Taken</h4>
                                        ...
                                        <div id="responsive" class="modal fade" data-width="560">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-4">Leave Type<span class="required"> * </span></label>
                                                            <div class="col-md-8">
                                                                <select name="relationship" id="select2_sample4" class="select2 form-control" required>
                                                                    ...
                                                                    <option value="">Replacement Leave</option>
													...
													to </span>
                                                        ...
                                                        <div class="col-md-12">
                                                            <br>
                                                            <div class="form-group">
                                                                <label class="control-label col-md-4">No. of Days <span class="required"> * </span></label>
                                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="right col-md-12">
                                                            <a class="btn green" data-toggle="modal" href="#responsive">Apply New Leave </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
