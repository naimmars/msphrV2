                    ...
                    <div class="col-md-12">
                        <div class="portlet box red">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-gift"></i>Add Dependent Details
                                </div>
                                <div class="tools">
                                ...
                                <form action="#" class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">ID No / Passport</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="relationship" id="select2_sample4" class="select2 form-control" onChange="getData(this);">
                                                            <option value="">Select Relationship</option>
                                                            <option value="SPO" onClick="">Spouse</option>
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-cogs"></i>List of Dependendts
                                </div>
                                <div class="tools">
                                    <a href="javascript:;" class="collapse">
                                    </a>
