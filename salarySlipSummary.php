                    ...
                    <div class="col-md-12">
                        <div class="portlet box red">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-pie-chart"></i>Timesheet Summary
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="#" class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h4 class="form-section">List of Timesheet</h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-4">Submission Date<span class="required"> * </span></label>
                                                            <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-12">
                                                        <br>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-4">Select Month<span class="required"> * </span></label>
                                                            <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-12">
                                                        <br>
                                                        <div class="form-group">
                                                            <label class=" col-xs-12 control-label col-md-4">Attach Document<span class="required"> * </span></label>
